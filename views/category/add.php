<form method="POST" class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="name" placeholder="Enter a category name" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-300" required>
    </div>
