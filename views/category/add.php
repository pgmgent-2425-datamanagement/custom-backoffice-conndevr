<form method="POST" class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6">
    <h1 class="text-2xl font-bold text-center mb-6">Categorie informatie</h1>

    <div class="mb-4">
        <label for="name" class="block text-sm font-semibold text-gray-700">Naam</label>
        <input type="text" name="name" placeholder="Schrijf een categorie titel" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-300" required>
    </div>
